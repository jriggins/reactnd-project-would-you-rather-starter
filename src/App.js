  ...
  render() {
    return (
      <div id="main">
        ...
        <PrivateRoute path="/add" component={AddQuestion} loggedInUser={this.props.loggedInUser}/>
        <PrivateRoute path="/leaderboard" component={Leaderboard} loggedInUser={this.props.loggedInUser}/>
        <div id="footer">
