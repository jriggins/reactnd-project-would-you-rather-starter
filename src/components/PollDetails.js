...
import { savePollAnswer } from '../actions/users';
  ...
  renderAnswered = () => {
    ...
    return (
      <div>
        ...
        <Avatar name={question.author} url={question.authorAvatarURL} />
...
function mapStateToProps({ loggedInUserId, questions, users }, props) {
